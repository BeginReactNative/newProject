...
export default class Login extends Component {
    ...
    render() {
        return <BackgroundWrapper  iconLeft="arrow-left-circle" onPressIcon={() => {this.props.navigation.goBack()}}>
            ...
            <AlertStatus textHelper="You're ready account" textAction="Login"
                         onPressAction={() => {this.props.navigation.navigate('LoginAnimate')}}></AlertStatus>
        </BackgroundWrapper>
    }
}
